...
import facebook from "../../images/imagesHero/facebook.svg";
import insta from "../../images/imagesHero/instagram.svg";
import MapAbout from "../aboutPage/MapAbout";





 function ContactInfo({context}) {
  ...
  let facebookLink = Object(generalContactInfo[0]).facebookPageLink;
  let instagramLink = Object(generalContactInfo[0]).instagramPageLink;
  return (
    <>
    <TitleCenter title={"CONTACT INFORMATION"}/>
    <div className={style.container}>
      <div className={style.grid}>
        ...
        <p className={style.pContact}> <b style={{color:"white"}}> PHONE: </b>  <span>&nbsp;&nbsp;</span>  (Mon-Fri: {phoneAvailabilityHours}) +{phoneNumber}</p>
        </a>
        </div>
        <div className={style.element3}>
        <a href={`mailto: ${emailAddress}`} style={{textDecoration:"none"}} className={style.aTag} > 
        <p className={style.pContact}> <b style={{color:"white"}}> EMAIL:  </b>  <span>&nbsp;&nbsp;</span> {emailAddress}</p>
        </a>
        </div>
        ...
        <a
          ...
          >
        <p className={style.pContact}> <b style={{color:"white"}}> ADDRESS: </b>  <span>&nbsp;&nbsp;</span> Gammeltorv 10, Aalborg 9000</p>
         </a>
        </div>
        ...
        <a
            ...
            className={style.aTag}
          >
        <p className={style.fbInsta}> <b> VISIT FACEBOOK </b> 
        <svg className={style.icon}  viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M21.12 0H0.88C0.39325 0 0 0.39325 0 0.88V21.12C0 21.6067 0.39325 22 0.88 22H21.12C21.6067 22 22 21.6067 22 21.12V0.88C22 0.39325 21.6067 0 21.12 0ZM20.24 20.24H15.1773V13.4805H18.0373L18.4662 10.1612H15.1773V8.041C15.1773 7.0785 15.444 6.424 16.8218 6.424H18.579V3.454C18.2737 3.41275 17.2315 3.322 16.016 3.322C13.4805 3.322 11.7452 4.87025 11.7452 7.711V10.1585H8.87975V13.4777H11.748V20.24H1.76V1.76H20.24V20.24Z" fill="white"/>
        ...
        <a
            ...
            className={style.aTag}
          >
        <p className={ style.fbInsta}> <b> INSTAGRAM </b> 
        <svg className={style.icon}   viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default withEventConsumer(ContactInfo);
